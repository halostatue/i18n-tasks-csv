# -*- encoding: utf-8 -*-
# stub: i18n-tasks-csv 1.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.files = ["Contributing.rdoc", "Gemfile", "History.rdoc", "Licence.rdoc", "Manifest.txt", "README.rdoc", "Rakefile", "lib/i18n_tasks_csv.rb"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<i18n-tasks>, ["~> 0.8"])
